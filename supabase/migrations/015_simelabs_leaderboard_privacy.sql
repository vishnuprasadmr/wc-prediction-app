-- Simelabs point table: server-side gate (verified SML ID only).
-- Global leaderboard no longer exposes employee_id.
...
-- Verified Simelabs employees only (caller must have valid SML ID on file).
