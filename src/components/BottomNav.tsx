...
const links = [
  { to: '/', label: 'Fixtures', ariaLabel: 'Fixtures', Icon: FixturesIcon, urgentKey: null },
  { to: '/predict', label: 'Predict', ariaLabel: 'Predict scores', Icon: PredictIcon, urgentKey: 'predict' as const },
  { to: '/leaderboard', label: 'Table', ariaLabel: 'Leaderboard', Icon: LeaderboardIcon, urgentKey: null },
  { to: '/profile', label: 'Profile', ariaLabel: 'Profile', Icon: ProfileIcon, urgentKey: null },
]
  ...
  return (
    ...
    >
      <div className="pointer-events-auto mx-auto flex max-w-lg items-stretch gap-0.5 rounded-2xl border border-default bg-card/98 p-1 shadow-[0_-4px_24px_rgb(0_0_0/0.18),0_8px_32px_rgb(38_203_153/0.12)] backdrop-blur-xl dark:shadow-[0_-4px_28px_rgb(0_0_0/0.55),0_0_0_1px_rgb(38_203_153/0.08),0_8px_32px_rgb(38_203_153/0.1)]">
        {links.map(({ to, label, ariaLabel, Icon, urgentKey }) => {
                ...
                <>
                  ...
                  {!isActive && showUrgent && (
                    <motion.div
                      ...
                      transition={{ duration: 1.2, repeat: Infinity }}
                      className="absolute inset-0 rounded-xl ring-2 ring-red-500/50"
                      aria-hidden
                    />
                  )}
                  <Icon
