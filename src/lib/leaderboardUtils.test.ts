...
describe('leaderboardUtils', () => {
  ...
  it('sorts players alphabetically for pre-tournament roster', () => {
    const entries: LeaderboardEntry[] = [
      { user_id: '1', display_name: 'Zara', total_points: 0, exact_scores: 0, predictions_made: 0, rank: 1 },
      { user_id: '2', display_name: 'Arun', total_points: 0, exact_scores: 0, predictions_made: 1, rank: 2 },
      { user_id: '3', display_name: 'Maya', total_points: 0, exact_scores: 0, predictions_made: 0, rank: 3 },
    ]
